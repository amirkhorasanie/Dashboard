          ...
          <div className="mt-4 flex relative text-neutral-500 flex-col gap-2">
            {menu.items.map((nav) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  clsx(
                    "flex items-center gap-1 px-3 py-2.5 font-bold rounded-2xl dark:hover:bg-cyan-600/10 dark:hover:text-cyan-500 hover:rounded-sm bg-black/5 dark:bg-black/25 transition-all hover:bg-cyan-200/60 duration-300",
                    isActive &&
